...
const languages = i18n.defaultLanguages.concat([]);  // i18n.defaultLanguages.concat(process.env.KOVIX_QUALITY !== 'stable' ? i18n.extraLanguages : []);
...
const compileEditorESMTask = task.define('compile-editor-esm', () => {
        ...
        if (FAIL_ON_PURPOSE || result.status !== 0) {
                ...
                return cleanDestPath.then(() => {
                        ...
                        console.log(`Open in CONSTRUCT IDE the folder at '${destPath}' and you can analyze the compilation error`);
