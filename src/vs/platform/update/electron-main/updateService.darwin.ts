...
export class DarwinUpdateService extends AbstractUpdateService implements IRelaunchHandler {
        ...
        private onUpdateDownloaded(update: IUpdate): void {
                ...
                type UpdateDownloadedClassification = {
                        owner: 'joaomoreno';
                        updateVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The version number of the new Kovix IDE that has been downloaded.' };
                        comment: 'This is used to know how often Kovix IDE has successfully downloaded the update.';
                };
                this.telemetryService.publicLog2<{ updateVersion: string }, UpdateDownloadedClassification>('update:downloaded', { updateVersion: update.version });
