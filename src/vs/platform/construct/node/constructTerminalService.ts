...
import { ITerminalExecutor, ITerminalExecResult, isBlocked, detectShellMetacharInArgs, isCommandInAllowlist, sanitiseForAuditLog, TerminalRateLimiter } from '../common/terminal/terminalExecutor.js';
