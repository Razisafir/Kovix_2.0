/*---------------------------------------------------------------------------------------------
 *  AI Execution Kernel -- Phase 4: Execution Sanity Validation
...
export const IExecutionSanityService = createDecorator<IExecutionSanityService>('construct.executionSanityService');
