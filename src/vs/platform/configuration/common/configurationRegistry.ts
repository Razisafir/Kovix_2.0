...
export const resourceLanguageSettingsSchemaId = 'construct://schemas/settings/resourceLanguage';
export const configurationDefaultsSchemaId = 'construct://schemas/settings/configurationDefaults';
