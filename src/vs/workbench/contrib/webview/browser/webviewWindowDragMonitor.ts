...
/**
 * Allows webviews to monitor when an element in the Kovix IDE editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Kovix IDE needs to see this
