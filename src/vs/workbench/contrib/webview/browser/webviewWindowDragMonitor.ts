...
/**
 * Allows webviews to monitor when an element in the CONSTRUCT IDE editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. CONSTRUCT IDE needs to see this
