...
export class SashSettingsController implements IWorkbenchContribution, IDisposable {
	...
	private onDidChangeSize(): void {
		...
		this.layoutService.mainContainer.style.setProperty('--kovix-sash-size', size + 'px');
		this.layoutService.mainContainer.style.setProperty('--kovix-sash-hover-size', hoverSize + 'px');
