...
export const terminalSuggestConfiguration: IStringDictionary<IConfigurationPropertySchema> = {
        ...
        [TerminalSuggestSettingId.BuiltinCompletions]: {
                ...
                properties: {
                        'pwshCode': {
                                description: localize('suggest.builtinCompletions.pwshCode', 'Custom PowerShell argument completers will be registered for Construct\'s `construct` and `construct-insiders` CLIs. This is currently very basic and always suggests flags and subcommands without checking context.'),
                                type: 'boolean'
                        },
                        'pwshGit': {
