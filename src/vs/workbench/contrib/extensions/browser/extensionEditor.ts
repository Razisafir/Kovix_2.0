			...
			<head>
				...
				<style nonce="${nonce}">
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--kovix-button-secondaryBackground);
						border-color: var(--kovix-button-border);
						border-radius: 50%;
						cursor: pointer;
					...
					#scroll-to-top:hover {
						background-color: var(--kovix-button-secondaryHoverBackground);
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--kovix-button-secondaryForeground);
						/* Chevron up icon */
