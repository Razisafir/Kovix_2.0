			...
			<head>
				...
				<style nonce="${nonce}">
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--construct-button-secondaryBackground);
						border-color: var(--construct-button-border);
						border-radius: 50%;
						cursor: pointer;
					...
					#scroll-to-top:hover {
						background-color: var(--construct-button-secondaryHoverBackground);
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--construct-button-secondaryForeground);
						/* Chevron up icon */
