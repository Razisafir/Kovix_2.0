...
export class ParameterHintsWidget extends Disposable implements IContentWidget {
	...
	private createParameterHintDOMNodes() {
		...
		const updateFont = () => {
			...
			element.style.setProperty('--construct-parameterHintsWidget-editorFontFamily', fontInfo.fontFamily);
			element.style.setProperty('--construct-parameterHintsWidget-editorFontFamilyDefault', EDITOR_FONT_DEFAULTS.fontFamily);
		};
