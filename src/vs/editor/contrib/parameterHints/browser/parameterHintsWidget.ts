...
export class ParameterHintsWidget extends Disposable implements IContentWidget {
	...
	private createParameterHintDOMNodes() {
		...
		const updateFont = () => {
			...
			element.style.setProperty('--kovix-parameterHintsWidget-editorFontFamily', fontInfo.fontFamily);
			element.style.setProperty('--kovix-parameterHintsWidget-editorFontFamilyDefault', EDITOR_FONT_DEFAULTS.fontFamily);
		};
