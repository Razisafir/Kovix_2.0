...
export class InlineEditsView extends Disposable {
	...
	constructor(
		...
		this._register(autorun(reader => {
			...
			path1.style.fill = 'var(--kovix-inlineEdit-originalBackground, transparent)';
			path1.style.stroke = 'var(--kovix-inlineEdit-border)';
			path1.style.strokeWidth = '1px';


			const path2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
			path2.setAttribute('d', pathBuilder2.build());
			path2.style.fill = 'var(--kovix-inlineEdit-modifiedBackground, transparent)';
			path2.style.stroke = 'var(--kovix-inlineEdit-border)';
			...
			pathModifiedBackground.style.fill = 'var(--kovix-editor-background, transparent)';
			...
			if (layoutInfo.shouldShowShadow) {
				...
				stop1.setAttribute('style', 'stop-color:var(--kovix-inlineEdit-border);stop-opacity:0');

				const stop2 = document.createElementNS('http://www.w3.org/2000/svg', 'stop');
				stop2.setAttribute('offset', '100%');
				stop2.setAttribute('style', 'stop-color:var(--kovix-inlineEdit-border);stop-opacity:1');
				...
				path3.style.stroke = 'var(--kovix-inlineEdit-border)';
			...
			path4.style.fill = 'var(--kovix-editor-background, transparent)';
