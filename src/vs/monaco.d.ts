...
declare namespace monaco.editor {
        ...
        export interface IActionDescriptor {
                ...
                label: string;
                /**
                 * Precondition rule. The value should be a [context key expression](https://github.com/Razisafir/KOVIX).
                 */
                precondition?: string;
                /**
...
declare namespace monaco.languages {
         ...
         * the [light bulb](https://github.com/Razisafir/KOVIX) feature.
         */
         ...
         * the [IntelliSense](https://github.com/Razisafir/KOVIX).
         *
